...
export default function DataEntryForm() {
  ...
  return (
    <div className="bg-white p-6 rounded-xl border border-blue-200 shadow-xl">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h2 className="text-2xl font-bold text-blue-600">Machine Data Entry</h2>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full bg-blue-600 text-white py-3 px-4 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed font-medium transition-all flex items-center justify-center gap-2"
        >
          {loading ? (
            <>
